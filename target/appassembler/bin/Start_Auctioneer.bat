...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="Start_Auctioneer" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" de.dailab.jiactng.aot.auction.StartAuctioneer %CMD_LINE_ARGS%
